...
namespace WebAppParcial.Controllers
{
    public class AreasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AreaID,Nombre,TiempoPrestamo")] Area area)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AreaID,Nombre,TiempoPrestamo")] Area area)
        {
            if (id != area.AreaID)
            {
                return NotFound();
